...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-[#0b1324]/95 backdrop-blur-lg border-t border-slate-800 md:hidden">
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-[10px] font-mono-tech leading-none">
                {item.name}
              </span>
            </Link>
          );
