...
6. **Leaderboard Global (`/ranking`)**: Exibir a classificação em tempo real dos leitores no dApp com badges de conquista (*"Leitor Fiel"*, *"Teólogo"*, *"Apóstolo"*).
...
```bash
# Executar Testes Unitários (11/11 aprovados)
cargo test

# Compilar Contrato para WebAssembly (28 funções exportadas)
